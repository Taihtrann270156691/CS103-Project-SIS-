...
public:
    ...
    Student(const std::string& firstName, const std::string& lastName, const std::string& dateOfBirth, const std::string& gender, const std::string& course)
        : firstName(firstName), lastName(lastName), dateOfBirth(dateOfBirth), gender(gender), course(course){}
    Student() = default;
